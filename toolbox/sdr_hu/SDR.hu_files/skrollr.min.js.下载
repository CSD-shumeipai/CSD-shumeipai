...
playback timings (ms):
  esindex: 0.028
  captures_list: 128.966
  RedisCDXSource: 12.273
  LoadShardBlock: 90.058 (3)
  exclusion.robots: 0.207
  CDXLines.iter: 20.738 (3)
  PetaboxLoader3.datanode: 99.75 (5)
  exclusion.robots.policy: 0.193
  PetaboxLoader3.resolve: 118.393 (2)
  load_resource: 166.931 (2)
*/